...
mcp = FastMCP("SearchServer", dependencies=["mcp", "duckduckgo-search", "chromadb", "sentence-transformers"])
...
def search_chroma_db(query: str, limit: int = 5) -> Dict:
    ...
    try:
        ...
        try:
            ...
            return {"success": False, "error": f"Collection '{collection_name}' not found. Ensure resumes are ingested."}
